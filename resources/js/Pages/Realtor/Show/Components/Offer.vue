<template>
    <Box>
        <template #header>
            Offer #{{ offer.id }}
            <span v-if="offer.accepted_at" class="dark:bg-green-900 dark:text-green-200 text-green-900 p-1 rounded-md uppercase ml-1 text-xs">
                accepted
            </span>
        </template>
            ...
            <div>
                ...
                <div class="text-gray-500">
                    ...
                    <Price :price="difference"
                           :class="{'text-green-500': difference > 0, 'text-red-500': difference <= 0}"/>
                </div>
