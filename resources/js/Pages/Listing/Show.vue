        ...
        <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
            <Box v-if="listing.images.length" class="md:col-span-7 flex items-center">
                <div class="grid grid-cols-2 gap-1">
                    <img v-for="image in listing.images" :key="image.id" :src="image.src" alt="image" />
                </div>
            </Box>
            ...
            <div class="md:col-span-5 flex flex-col gap-4">
                ...
                <Box>
                    ...
                    <div>
                        ...
                        <input type="range" v-model.number="interestRate" min="0.1" max="30" step="0.1" class="w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
                        <label class="label">Duration ({{ duration }} years)</label>
                        <input type="range" v-model.number="duration" min="3" max="40" step="1" class="w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
