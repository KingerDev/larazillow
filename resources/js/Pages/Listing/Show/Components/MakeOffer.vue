    ...
    <Box>
        ...
        <div>
            <form @submit.prevent="makeOffer">
                ...
                <input type="range" v-model.number="form.amount" :min="min" :max="max" step="10000" class="mt-2 w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
...
watch(() => form.amount,
    debounce((value) => emit('offerUpdated', value))
)
